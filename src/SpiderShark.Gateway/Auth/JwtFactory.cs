...
namespace SpiderShark.Gateway.Auth
{
    public class JwtFactory : IJwtFactory
    {
        ...
        public async Task<Token> GenerateEncodedToken(long id, string userName)
        {
        ...
        private static ClaimsIdentity GenerateClaimsIdentity(long id, string userName)
        {
